        ...
        <div className="lg:flex  justify-between  pb-7 lg:pb-0 items-center">
          ...
          <div className="xl:w-6/12 lg:w-6/12 w-full">
            <div className="z-10  relative  ">
              <div className="absolute md:right-52 top-12  rounded-full xl:size-90 -z-20 xl:right-30 lg:right-0 right-15 md:size-72 size-60   bg-purple-300" />
              <img
                src={profileImg}
                className="xl:w-[50%] md:w-[40%] md:left-40 lg:w-[60%] w-[60%] relative xl:left-40 left-10 top-10 z-20 bg-linear-to-b from-[#302e3036] to-[#372137ec]  rounded-full border-2 border-purple-200"
              />
            </div>
